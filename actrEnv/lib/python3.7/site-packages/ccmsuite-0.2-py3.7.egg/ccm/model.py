...
"""
What would __getitem__ do for this class? need to figure that out
because right now it doesn't have one and that is what the error is tied to
maybe it should be converted somewhere and isn't?
"""
    ...
    def __convert(self,parent=None,name=None):
        ...
        if self._convert_methods:
          for name,func in list(methods.items()):
              #print("120 - " + str(func))
              #print("121 - " + str(func.__code__.co_flags))
